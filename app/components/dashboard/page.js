...
export default function dashboard() {
  return (
    <div className="bg-bg1 w-full h-full flex md:flex-row flex-col pb-10">
      <div className="pt-10">
        <div className="sidebar w-[288px] h-[940px] bg-[#000] rounded-3xl ml-[40px] flex flex-col font-mont">
      ...
      <div className="ml-12 mt-10">
        ...
        <div className="flex flex-row gap-12 mt-5">
            <div className="w-[222px] h-[120px] bg-box1 rounded-2xl">
                <Image src={"/Vector1.svg"} width={28} height={28} className="ml-[11.4rem] mt-3"/>
            </div>
            <div className="w-[222px] h-[120px] bg-box2 rounded-2xl">
                <Image src={"/total_transactions_icon.svg"} width={20} height={20} className="ml-[11.4rem] mt-3"/>
            </div>
            <div className="w-[222px] h-[120px] bg-box3 rounded-2xl">
                <Image src={"/Vector2.svg"} width={20} height={20} className="ml-[11.4rem] mt-3"/>
            </div>
            <div className="w-[222px] h-[120px] bg-box4 rounded-2xl">
                <Image src={"/Vector3.svg"} width={28} height={28} className="ml-[11.4rem] mt-3"/>
            </div>
        </div>
        <div className="activities w-[1030px] h-[359px] bg-acti rounded-2xl mt-10">
            <h2 className="font-semibold font-mont ml-7 pt-5">Activities</h2>
        </div>
        <div className="flex flex-row gap-[4.4rem] mt-10">
            <div className="w-[480px] h-[256px] rounded-2xl bg-acti">
                <h2 className="font-semibold font-mont ml-7 pt-5">Top Products</h2>
            </div>
            <div className="w-[480px] h-[256px] rounded-2xl bg-acti">
                <h2 className="font-semibold font-mont ml-7 pt-5">Today’s schedule</h2>
            </div>
        </div>
      </div>
    </div>
